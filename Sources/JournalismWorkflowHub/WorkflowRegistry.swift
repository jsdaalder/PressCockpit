        ...
        return [
            WorkflowDefinition(
                ...
                parameters: [
                    ...
                    .init(id: "status", label: "Legacy status", kind: .choice, helpText: "Compatibility field kept during migration. Canonical project-state fields take precedence.", defaultValue: "active", choices: ["active", "on_hold", "done", "archived"]),
